...
def replicating_consigner_trips_to_elasticsearch(kafka, client, logger)
  ...
  kafka.each_message do |message|
    ...
    if payload_after.nil?
      begin
        client.delete(index: 'master_index', type: 'master_type',
                      id: payload_before['id'])
      rescue StandardError => e
    ...
    begin
      ...
      begin
        ...
        client.index(index: 'master_index', type: 'master_type',
...
def fetching_data_from_kafka(client, logger)
  ...
  es_consumer_consigner_trips.subscribe(
    'dbserver1.dipper_development.consigner_trips', start_from_beginning: true
  )
  logger.info('FETCHING DATA FROM KAFKA')
  begin
    replicating_consigner_trips_to_elasticsearch(es_consumer_consigner_trips,
                                                 client, logger)
  rescue StandardError => e
...
def main
  ...
  #* 3: Creating Index
  logger.info('CREATING INDEX AND MAPPINGS')
  # client.indices.delete(index: "master_index")
  # client.indices.create(index: "master_index",
  #   body: {
  #     settings: {
  #       index: {
  #         number_of_shards: 1,
  ...
  #       master_type: {
  #         properties: {
  #           # STATIC DATA CONSIGNER_TRIP
  #           id: {type: 'long'},
  #           trucker_id: {type: 'long'},
  #           shipper_id: {type: 'long'},
  #           consigner_id: {type: 'long'},
  #           consignee_id: {type: 'long'},
  #           source: {type: 'keyword'},
  #           invoice_no: {type: 'keyword'},
  #           lorry_receipt_no: {type: 'keyword'},
  #           consigner_name: {type: 'keyword'},
  #           consignee_name: {type: 'keyword'},
  #           transporter: {type: 'keyword'},
  #           eta: {type: 'date', format: "strict_date_optional_time||epoch_millis"},
  #           origin: {type: 'keyword'},
  #           destination: {type: 'keyword'},
  #           loading_area: {type: 'keyword'},
  ...
  #           slug: {type: 'keyword'},
  #           card_no: {type: 'keyword'},
  #           vehicle_entry_time: {type: 'keyword'},
  #           vehicle_exit_time: {type: 'keyword'},
  #           vehicle_no: {type: 'keyword'},
  #           status: {type: 'keyword'},
  #           state: {type: 'keyword'},
  #           consigner_pincode_id: {type: 'long'},
  #           consignee_pincode_id: {type: 'long'},
  #           closure_reason: {type: 'keyword'},
  #           consigner_code: {type: 'keyword'},
  #           loading_in_time: {type: 'date'},
  #           loading_out_time: {type: 'date', format: "strict_date_optional_time||epoch_millis"},
  #           unloading_in_time: {type: 'date', format: "strict_date_optional_time||epoch_millis"},
  #           unloading_out_time: {type: 'date', format: "strict_date_optional_time||epoch_millis"},
  #           IMEI: {type: 'keyword'},
  #           loading_poi_id: {type: 'long'},
  #           unloading_poi_id: {type: 'long'},
  #           unloading_poi_history_id: {type: 'long'},
  #           loading_poi_history_id: {type: 'long'},
  #           ship_to_code: {type: 'keyword'},
  #           is_external: {type: 'boolean'},
  #           lr_no: {type: 'keyword'},
  #           challan_no: {type: 'keyword'},
  #           invoice_qty: {type: 'integer'},
  #           delivery_no: {type: 'keyword'},
  #           gate_entry_no: {type: 'keyword'},
  #           temp_consigner_trip_id: {type: 'long'},
  #           plant_code: {type: 'keyword'},
  #           deleted_at: {type: 'date', format: "strict_date_optional_time||epoch_millis"},
  #           return_load: {type: 'keyword'}, #DB INT
  #           parent_trip_id: {type: 'long'},
  #           ancestor_id: {type: 'long'},
  #           leg_no: {type: 'long'},
  #           material: {type: 'keyword'},
  #           meta_data: {type: 'text'},
  #           # CUSTOM FIELDS
  #           loading_in_out_mins_diff: {type: 'long'},
  #           unloading_in_out_mins_diff: {type: 'long'},
  #           consigner_lat_lon: {type: 'geo_point'},
  #           consignee_lat_lon: {type: 'geo_point'},
  #           # DYNAMIC MAPPING FOR DATA_STRING
  #           data_string: {
  #             properties: {
  #               destination_lat_lon: {type: "geo_point"},
  #             }
  #           },
  #         },
  #         dynamic_templates: [
  ...
  #               match_pattern: "regex",
  #               match: "^(data_string.*_no|data_string.*_code)$"
  #             }
  #           }
  #         ]
  #       }
  ...
  unless ARGV.empty?
    consigner_trips = ConsignerTrip.where('updated_at >= ?',
                                          ARGV[0])
  end
