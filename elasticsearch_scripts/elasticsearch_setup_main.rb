...
def fetching_data_from_kafka(client, logger)
  ...
  es_consumer_consigner_trips.subscribe("dbserver1.dipper_development.consigner_trips", start_from_beginning: true)
...
def main
  ...
  consigner_trips = ConsignerTrip.where("updated_at >= ?", ARGV[0]) unless ARGV.empty?
