...
require_relative('../models/poi_config')
include(Replicate)
retries ||= 3
...
def main
  ...
  consumer_poi_configs.subscribe('dbserver1.dipper_development.poi_configs',
                                 start_from_beginning: false)
  Replicate.replicating_template('default_poi_configs', consumer_poi_configs,
                                 logger)
