...
require_relative("../models/default_poi_config.rb")
include(Replicate)
retries ||= 3
...
def main
  ...
  consumer_default_poi_configs.subscribe("dbserver1.dipper_development.default_poi_configs", start_from_beginning: false)
  Replicate.replicating_template("default_poi_configs", consumer_default_poi_configs, logger)
