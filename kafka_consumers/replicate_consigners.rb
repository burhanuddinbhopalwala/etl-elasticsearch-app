...
require_relative('../models/consigner')
include(Replicate)
retries ||= 3
...
def main
  ...
  consumer_consigners.subscribe('dbserver1.dipper_development.consigners',
                                start_from_beginning: false)
  Replicate.replicating_template('consigners', consumer_consigners, logger)
