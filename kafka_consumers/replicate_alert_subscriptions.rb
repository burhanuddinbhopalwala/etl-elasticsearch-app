...
require_relative('../models/alert_subscription')
include(Replicate)
retries ||= 3
...
def main
  ...
  consumer_alert_subscriptions.subscribe(
    'dbserver1.dipper_development.alert_subscriptions', start_from_beginning: false
  )
  Replicate.replicating_template('alert_subscriptions',
                                 consumer_alert_subscriptions, logger)
